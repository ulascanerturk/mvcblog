...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-8 col-md-10 mx-auto">
				...
				<form action='<s:url value="/postadd"></s:url>' method="POST">
					<div class="form-group">
						<label for="cat">Kategori</label> <select name="kategori"
							class="form-control" id="cat">
							<c:if test="${ not empty categories }">
								<c:forEach var="item" items="${ categories }">
									<option value="${ item.getCid() }"> <c:out value='${ item.getCategory() }'></c:out></option>
								</c:forEach>
							</c:if>
						</select>
					</div>
					<div class="form-group">
						<label for="baslik">Başlık</label> <input name="baslik"
							id="baslik" type="text" class="form-control"
							placeholder="Başlık Giriniz... ">
					</div>
					<div class="form-group">
						<label for="sAciklama">Açıklama</label>
						<textarea id="editor1" name="aciklama" rows="10" cols="80"></textarea>
					</div>
					<div class="form-group">
	...
	<script
		src='<s:url value="resources/bower_components/ckeditor/ckeditor.js"></s:url>'></script>
